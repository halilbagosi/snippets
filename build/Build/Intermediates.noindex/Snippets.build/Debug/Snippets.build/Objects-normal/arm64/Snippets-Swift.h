...
@class NSApplication;
SWIFT_CLASS("_TtC8Snippets11AppDelegate")
...
@class NSCoder;
@class NSScrollView;
SWIFT_CLASS("_TtC8Snippets19LineNumberRulerView")
...
SWIFT_CLASS("_TtC8Snippets25LoopingVideoContainerView")
@interface LoopingVideoContainerView : NSView
...
@class MTKView;
SWIFT_CLASS("_TtC8Snippets27MetalDisintegrationRenderer")
@interface MetalDisintegrationRenderer : NSObject <MTKViewDelegate>
